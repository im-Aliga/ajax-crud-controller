...
namespace DemoApplication.Areas.Client.Controllers
{
    ...
    public class BookController : Controller
    {
        ...
        #region Modal
        [HttpGet("modal/{id}", Name = "book-modal")]
        public ActionResult GetBook([FromRoute] int id)
        {
            var book = _dbContext.Books.Include(b => b.Author).FirstOrDefault(b => b.Id == id);
            ...
            var model = new ModalViewModel(book.Id, book.Title, book.Price, $"{book.Author.FirstName} {book.Author.LastName}", book.CreatedAt);

            return PartialView("~/Areas/Client/Views/Shared/Partials/_BookModalPartial.cshtml", model);
